...
import com.spring.cloud.com.fallback.FeignClientFallback;
import com.spring.cloud.com.fallback.FeignClientFallbackFactory;
import feign.Param;
...
@FeignClient(name = "microservice-provider-user", fallbackFactory = FeignClientFallbackFactory.class, configuration = FeignConfiguration.class)
